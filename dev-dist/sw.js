...
define(['./workbox-f87553f6'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "index.html",
    "revision": "0.lal3hejurps"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/\/images\/guelaguetza-.*\.png$/, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https?:\/\/localhost:3005\/api\/stories/, new workbox.NetworkFirst({
